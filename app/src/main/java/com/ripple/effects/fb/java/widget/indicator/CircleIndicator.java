...
public class CircleIndicator extends LinearLayout {
    ...
    public void setViewPager(ViewPager viewPager, int numIndicator) {
        mViewpager = viewPager;
        mNumIndicator = numIndicator;
    ...
    private void createIndicators() {
        removeAllViews();
        int count = (mNumIndicator >= 0) ? mNumIndicator : mViewpager.getAdapter().getCount();
        if (count <= 0) {
            return;
        }
